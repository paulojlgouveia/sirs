<?php 
	...
	try {
		$queued = get_user_queued_auctions($_SESSION['id']);
...
/*		http://stackoverflow.com/questions/13465052/html-code-to-put-image-in-left-and-text-in-right-side-of-screen-with-footer-belo
	...
	<body>
		...
		<div class="productListingSection">
				...
				<h3> Queued Auctions </h3>
				
				<?php foreach($queued as $item) { ?>
								...
								<div class="product-info smart-form">
									<div class="row">
										<div class="col-md-12"> 
											...
											<a href="javascript:void(0);" class="btn btn-info" style="float:right;"><span>Edit Auction</span></a>
										</div>
									</div>
								</div>
							</div>
