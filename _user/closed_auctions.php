...
<?php
	...
	try {
		$closed = get_user_closed_auctions($_SESSION['id']);
							...
							<div class="col-md-7 col-sm-12 col-xs-12">
								...
								<div class="product-detail">
									...
									<p class="price-container">
										<span style="color:darkgrey; font-size:16px;">winner <span style="font-size:larger; color:#00AC11">FIXME</span> with bid <span><?=$item['value']?> €</span></span>
									</p>
